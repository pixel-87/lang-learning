...
Challenge: 01-arrays-in-go
Chapter: 08-slices

Arrays are fixed-size groups of variables of the same type. For examle, [4]string is an array of `4` values of type `string`.

To declare an array of 10 integers:

`var myInts [10]int`

Or to declare an initialised literal:
...
3. "!" costs 1, adding the previous messages makes ttoal cost 11 (5 + 5 + 1)
